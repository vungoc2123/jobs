...
class AppItemFilter extends StatefulWidget {
  const AppItemFilter(
      {super.key,
  ...
  @override
  State<AppItemFilter> createState() => _AppItemFilterState();
}

class _AppItemFilterState extends State<AppItemFilter> {
  ...
  @override
  void didUpdateWidget(covariant AppItemFilter oldWidget) {
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
              ...
              border: Border.all(color: AppColors.greyDF)),
          child: Row(
            mainAxisSize: MainAxisSize.min,
            children: [
              Text(
